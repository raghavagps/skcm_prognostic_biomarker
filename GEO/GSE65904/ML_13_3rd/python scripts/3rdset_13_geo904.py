...
## 13 genes found out of 20 in 3rd set of biomarkers ##
...
# Step 6: Save to CSV
selected_df.to_csv('13_3rdset_expression_with_DSS.csv',index=False)
...
geo_ex.to_csv("geo_final_13.csv", index=False)
...
results_df.to_csv('geo904_13_other_before_smote.csv', index=False)
...
# Save results_df to a CSV file
results_df.to_csv('geo_13_904.csv', index=False)
...
# Save results_df to a CSV file
results.to_csv('geo904_13_catboost.csv', index=False)

# Save as Python pickle (optional, not the recommended CatBoost way)
import joblib
joblib.dump(model, "best_catboost_model_13.pkl")
...
plt.savefig('auc_plot_geo904_13.png', dpi=300, bbox_inches='tight')

# Display the plot
plt.show()

# Download the saved plot
files.download('auc_plot_geo904_13.png')